...
export default function AddEditBlogModal() {
  ...
  useEffect(() => {
    if (addBlog && addEditModal) {
      setBlog(addBlog);
      addEditModal.show();
    } else if (editBlog && addEditModal) {
      setBlog(editBlog);
      addEditModal.show();
    }
  ...
  console.log(blog, "blogUPdate", categories)
                ...
                <div className="input-group mb-3">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      console.log(blog, categories, category)
                      const blogUpdate = {
                        ...blog,
